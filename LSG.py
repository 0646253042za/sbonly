...
print("\Levii's Guard ᴠᴇʀ.8.14.2 ᴘʀᴏᴛᴇᴄᴛ \n__________________________")

"""
Levii' Guard ᴠᴇʀ.8.14.2 ᴘʀᴏᴛᴇᴄᴛ
"""
print("login success")
oepoll = OEPoll(cl)
call = cl

creator = ["u8202671678dee91342ed891095dd55bc"]
owner = ["u8202671678dee91342ed891095dd55bc"]
admin = ["u8202671678dee91342ed891095dd55bc"]
staff = ["u8202671678dee91342ed891095dd55bc"]
...
offbot = []
welcome = []
#Ü•➤Ü•➤Ü•➤Ü•LEVII'S GUARD➤Ü•➤Ü•➤Ü•➤Ü•➤Ü•➤
nama1 = 'Levii°S Guard'
Headers3 = {
...
wait = {
    ...
    "comment1": "ᴀᴜᴛᴏ ʟɪᴋᴇ ɴ ᴄᴏᴍᴍᴇɴᴛ ᴅᴏɴᴇ\nвʏ.ᴛᴇᴀᴍ ⊶ Levii°S Guard ⊷ \nline.me/ti/p/~adreamer_",
    "comment2": "╭━━━━━━━━━━━━━━━━━━━━━━━━\n┃ ╔══════════════════━━━━╮\n┃ ║   Ü     BY BOT : Levii'S Guard  Ü\n┃ ╚══════════════════━━━━╯\n├━━━━━━━━━━━━━━━━━━━━━━━━\n┃ ╔══════════════════━━━━╮\n┃ ║  Ü LIKE DONE \n┃ ║  Ü COMMENT DONE \n┃ ║  Ü Levii'S Guard\n┃ ╚══════════════════━━━━╯\n├━━━━━━━━━━━━━━━━━━━━━━━━\n┃ ╔══════════════════━━━━╮\n┃ ║  http://line.me/ti/p/~adreamer_\n┃ ╚══════════════════━━━━╯\n╰━━━━━━━━━━━━━━━━━━━━━━━━",
...
leviiProfile = cl.getProfile()
myProfile["displayName"] = leviiProfile.displayName
myProfile["statusMessage"] = leviiProfile.statusMessage
myProfile["pictureStatus"] = leviiProfile.pictureStatus
        ...
        for tmp in temp_flood:
            if temp_flood[tmp]["expire"] == True:
                if time.time() - temp_flood[tmp]["time"] >= 3*10:
                    ...
                    try:
                        cl.sendMessage(tmp, "Levii'S Guard Active")
                    except Exception as error:
                        logError(error)
    ...
    try:
        ...
        for i in mid:
            ...
            if no < len(mid):
                ...
                try:
                    no = "\n╚Ü•➤[ {} ]".format(str(cl.getGroup(to).name))
                except:
                    no = "\n╚Ü•➤[ Success ]"
        cl.sendMessage(to, textx, {'MENTION': str('{"MENTIONEES":' + json.dumps(arr) + '}')}, 0)
    except Exception as error:
...
def welcomeMembers(to, mid):
    try:
        arrData = ""
        textx = "Welcome and enjoying the room"
        arr = []
        no = 1
        num = 2
        for i in mid:
            ...
            "contents": {
             ...
             "header": {
               ...
               "contents": [
                 {
                   "type": "text",
                   "text": "WELCOME AND ENJOY THE ROOM",
                   "weight": "bold",
                   "color": "#FF0000",
                   "size": "xxl"
                 }
    ...
    try:
        ...
        for i in mid:
            ...
            if no < len(mid):
                ...
                try:
                    no = "\n╚Ü•➤[ {} ]".format(str(line.getGroup(to).name))
                except:
                    no = "\n╚Ü•➤[ Success ]"
        cl.sendMessage(to, textx+"╰━━━━━━━━━━━━━━━━━━━━╯", {'MENTION': str('{"MENTIONEES":' + json.dumps(arr) + '}')}, 0)
    except Exception as error:
...
def sendTextTemplate44(to, text):
    ...
    data = {
            "type": "flex",
            "altText": "{} Loving ".format(cl.getProfile().displayName),
            "contents": {
             "type": "bubble",
             "styles": {
               "header": {
...
def sendTextTemplate4(to, text):
    data = {
                                "type": "flex",
                                "altText": "{} Skuy Lur".format(cl.getProfile().displayName),
                                "contents": {
  "type": "bubble",
  "body": {
    "type": "box",
...
def sendCyduk(to, text):
    ...
    data = {
                                "type": "flex",
                                "altText": "{} find you ".format(leviiProfile.displayName),
                                "contents": {
  "styles": {
    "body": {
      "backgroundColor": "#000080"
    ...
    "contents": [
      {
        "contents": [
          {
            "text": "BIO DATA\nÜ NAMA: {}".format(cl.getContact(op.param2).displayName)+"\nÜ GROUP: {}".format(str(len(grouplist)))+"\nÜ FRIEND : {}".format(str(len(contactlist)))+"\nÜ FAFORITE : {}".format(str(len(favoritelist)))+"\nÜ BLOCKED : {}".format(str(len(blockedlist)))+"\nBio: {}".format(cl.getContact(op.param2).statusMessage),
            "size": "sm",
            "color": "#FF3366",
            "wrap": True,
            "type": "text",
...
def help():
    ...
    key = key.title()
    helpMessage = extras + "╔━━═Ü• LEVII'S MENU •Ü═━━╗\n" + \
                  "╠Ü•➤" + key + "Ü•➤.HELP•Ü\n" + \
                  "╠Ü•➤" + key + ".Me\n" + \
                  "╠Ü•➤" + key + ".Tokenlist\n" + \
                  "╠Ü•➤" + key + ".Memberpict\n" + \
                  ...
                  "╠Ü•➤" + key + ".Sprespon\n" + \
                  "╠Ü•➤" + key + ".Tag/bang\n" + \
                  "╠Ü•➤" + key + ".Tag room:「No grup」\n" + \
                  "╠Ü•➤" + key + ".Ginfo\n" + \
                  "╠Ü•➤" + key + ".Open\n" + \
                  "╠Ü•➤" + key + ".Close\n" + \
                  "╠Ü•➤" + key + ".Gurl\n" + \
                  "╠Ü•➤" + key + ".Gruplist\n" + \
                  "╠Ü•➤" + key + ".Infogrup「angka」\n" + \
                  "╠Ü•➤" + key + ".Infomem「angka」\n" + \
                  "╠Ü•➤" + key + ".Remove chat\n" + \
                  "╠Ü•➤" + key + ".Lurking「on/off」\n" + \
                  "╠Ü•➤" + key + ".Lurkers\n" + \
                  "╠Ü•➤" + key + ".Sider「on/off」\n" + \
                  "╠Ü•➤" + key + ".Myup\n" + \
                  "╠Ü•➤" + key + ".Updategrup\n" + \
                  "╠Ü•➤" + key + ".Bcast: / Gcast:「Text」\n" + \
                  "╠Ü•➤" + key + ".Pmcast:「Text」\n" + \
                  "╠Ü•➤" + key + ".Setkey「New Key」\n" + \
                  "╠Ü•➤" + key + ".Mykey\n" + \
                  "╠Ü•➤" + key + ".Resetkey\n" + \
                  "╠Ü•➤" + key + "Ü•.HIBURAN•Ü\n" + \
                  "╠Ü•➤" + key + ".Movie\n" + \
                  "╠Ü•➤" + key + ".ID line:「Id Line nya」\n" + \
                  "╠Ü•➤" + key + ".Sholat:「Nama Kota」\n" + \
                  "╠Ü•➤" + key + ".Cuaca:「Nama Kota」\n" + \
                  "╠Ü•➤" + key + ".Lokasi:「Nama Kota」\n" + \
                  "╠Ü•➤" + key + ".Musik「Judul Lagu」\n" + \
                  "╠Ü•➤" + key + ".Lirik:「Judul Lagu」\n" + \
                  "╠Ü•➤" + key + ".Ytmp3:「Judul Lagu」\n" + \
                  "╠Ü•➤" + key + ".Ytmp「Judul Video」\n" + \
                  "╠Ü•➤" + key + ".Profileig:「Nama IG」\n" + \
                  "╠Ü•➤" + key + ".Cekdate:「tgl-bln-thn」\n" + \
                  "╠Ü•➤" + key + ".Jumlah:「angka」\n" + \
                  "╠Ü•➤" + key + ".Spamtag「@」\n" + \
                  "╠Ü•➤" + key + ".Spamcall:「jumlahnya」\n" + \
                  "╠Ü•➤" + key + ".Spamcall\n" + \
                  "╠Ü•➤" + key + ".Notag「on/off」\n" + \
                  "╚━━═Ü•LEVII'S GUARD V.2•Ü═━━╝"
    return helpMessage

def helpa():
    key = Setmain["keyCommand"]
    key = key.title()
    helpMessagea = extras + "╔━━═Ü• LEVII'S MENU •Ü═━━╗\n" + \
                  "╠Ü•➤" + key + "Ü•.ARESPONSE•Ü\n" + \
                  "╠Ü•➤" + key + ".Sticker「on/off」\n" + \
                  "╠Ü•➤" + key + ".R1「on/off」\n" + \
                  "╠Ü•➤" + key + ".R2「on/off」\n" + \
                  "╠Ü•➤" + key + ".PM「on/off」\n" + \
                  "╠Ü•➤" + key + ".Contact「on/off」\n" + \
                  "╠Ü•➤" + key + ".Autojoin「on/off」\n" + \
                  "╠Ü•➤" + key + ".Autoadd「on/off」\n" + \
                  "╠Ü•➤" + key + ".Autoblock「on/off」\n" + \
                  "╠Ü•➤" + key + ".Wc「on/off」\n" + \
                  "╠Ü•➤" + key + ".Autoleave「on/off」\n" + \
                  "╠Ü•➤" + key + ".Admin:on\n" + \
                  "╠Ü•➤" + key + ".Admin:repeat\n" + \
                  "╠Ü•➤" + key + ".Staff:on\n" + \
                  "╠Ü•➤" + key + ".Staff:repeat\n" + \
...
def helpbot():
    key = Setmain["keyCommand"]
    key = key.title()
    helpMessage1 = extras + "╔━━━═Ü•Ü• LEVII'S MENU •Ü•Ü═━━━╗\n" + \
                  "╠Ü•➤" + key + "Ü•.HELPBOT•Ü\n" + \
                  "╠Ü•➤" + key + ".Blc\n" + \
                  "╠Ü•➤" + key + ".Ban:on\n" + \
                  "╠Ü•➤" + key + ".Unban:on\n" + \
                  ...
                  "╠Ü•➤" + key + ".Cek respon \n" + \
                  "╠Ü•➤" + key + ".Cek welcome\n" + \
                  "╠Ü•➤" + key + ".Set sider:「Text」\n" + \
                  "╠Ü•➤" + key + ".Set spam:「Text」\n" + \
                  "╠Ü•➤" + key + ".Set pesan:「Text」\n" + \
                  "╠Ü•➤" + key + ".Set r1:「Text」\n" + \
                  "╠Ü•➤" + key + ".Set r2:「Text」\n" + \
                  "╠Ü•➤" + key + ".Set pm:「Text」\n" + \
                  "╠Ü•➤" + key + ".Set Autojoin:「Text」\n" + \
                  "╠Ü•➤" + key + ".Set welcome:「Text」\n" + \
                  "╠Ü•➤" + key + ".Myname:「Nama」\n" + \
                  "╠Ü•➤" + key + ".Gift:「Mid korban」「Jumlah」\n" + \
                  "╠Ü•➤" + key + ".Spam:「Mid korban」「Jumlah」\n" + \
                  "╚━━━━═Ü•Ü•LEVII'S MENU V.2•Ü•Ü═━━━━╝"
    return helpMessage1
            ...
            if msg.toType == 2:
               ...
               if msg.contentType == 16:
                    if wait["Timeline"] == True:
                            ret_ = "Ü•➤ Detail PostinganÜ•➤"
                            if msg.contentMetadata["serviceType"] == "GB":
                                contact = cl.getContact(sender)
                                auth = "\nÜ•➤  Penulis : {}".format(str(contact.displayName))
                            else:
                                auth = "\nÜ•➤  Penulis : {}".format(str(msg.contentMetadata["serviceName"]))
                            ret_ += auth
                            if "stickerId" in msg.contentMetadata:
                                stck = "\nÜ•➤  Stiker : https://line.me/R/shop/detail/{}".format(str(msg.contentMetadata["packageId"]))
                                ret_ += stck
                            if "mediaOid" in msg.contentMetadata:
                                object_ = msg.contentMetadata["mediaOid"].replace("svc=myhome|sid=h|","")
                                if msg.contentMetadata["mediaType"] == "V":
                                    if msg.contentMetadata["serviceType"] == "GB":
                                        ourl = "\nÜ•➤  Objek URL : https://obs-us.line-apps.com/myhome/h/download.nhn?tid=612w&{}".format(str(msg.contentMetadata["mediaOid"]))
                                        murl = "\nÜ•➤  Media URL : https://obs-us.line-apps.com/myhome/h/download.nhn?{}".format(str(msg.contentMetadata["mediaOid"]))
                                    else:
                                        ourl = "\nÜ•➤  Objek URL : https://obs-us.line-apps.com/myhome/h/download.nhn?tid=612w&{}".format(str(object_))
                                        murl = "\nÜ•➤  Media URL : https://obs-us.line-apps.com/myhome/h/download.nhn?{}".format(str(object_))
                                    ret_ += murl
                                else:
                                    if msg.contentMetadata["serviceType"] == "GB":
                                        ourl = "\nÜ•➤  Objek URL : https://obs-us.line-apps.com/myhome/h/download.nhn?tid=612w&{}".format(str(msg.contentMetadata["mediaOid"]))
                            ...
                            if "text" in msg.contentMetadata:
                                text = "\nÜ•➤  Tulisan : {}".format(str(msg.contentMetadata["text"]))
                                purl = "\nÜ•➤  Post URL : {}".format(str(msg.contentMetadata["postEndUrl"]).replace("line://","https://line.me/R/"))
                                ret_ += purl
                                ret_ += text
        ...
        if op.type == 5:
            if settings['autoBlock'] == True:
                try:
                    ...
                    cl.sendMessage(op.param1, "Hii {} Sorry Auto Block , Komen di TL dulu ya kalo akun asli baru di unblock".format(usr.displayName))
...
#===========================
        if op.type == 26 or op.type == 26:
            ...
            if msg.contentType == 7:
                   ...
                   ret_ = "╭━━━━══════════════\n"
                   ret_ = "\n┣Ü•➤「 Sticker Info 」"
                   ret_ += "\n┣Ü•➤ Sticker ID : {}".format(stk_id)
                   ret_ += "\n┣Ü•➤ Sticker Version : {}".format(stk_ver)
                   ret_ += "\n┣Ü•➤ Sticker Package : {}".format(pkg_id)
                   ret_ += "\n┣Ü•➤ Sticker Url : line://shop/detail/{}".format(pkg_id)
                   ret_ += "\n╰━━━━══════════════\n"
                   query = int(stk_id)
                   if type(query) == int:
                    ...
                    if msg_id in msg_dict:
                        if msg_dict[msg_id]["from"]:
                           if msg_dict[msg_id]["text"] == 'Gambarnya dibawah':
                                ...
                                zx2 = []
                                xpesan = "╭━━━━══════════════\n┣Ü•➤「 Gambar Dihapus 」\n┣Ü•➤ Pengirim"
                                ret_ = "\n┣Ü•➤ Nama Grup : {}".format(str(ginfo.name))
                                ret_ += "\n┣Ü•➤ Waktu Dikirim : {}".format(dt_to_str(cTime_to_datetime(msg_dict[msg_id]["createdTime"])))
                                ret_ += "\n╰━━━━══════════════"
                                ...
                                ret_ = "╭━━━━══════════════"
                                ret_ += "\n┣Ü•➤ Pesan Dihapus"
                                ret_ += "\n┣Ü•➤  Pengirim : {}".format(str(levii.displayName))
                                ret_ += "\n┣Ü•➤  Nama Grup : {}".format(str(ginfo.name))
                                ret_ += "\n┣Ü•➤  Waktu Dikirim : {}".format(dt_to_str(cTime_to_datetime(msg_dict[msg_id]["createdTime"])))
                                ret_ += "\n┣Ü•➤  Pesannya : {}".format(str(msg_dict[msg_id]["text"]))
                                ret_ += "\n╰━━━━══════════════"
                ...
                try:
                    ...
                    if msg_id in msg_dict1:
                        if msg_dict1[msg_id]["from"]:
                                ...
                                ret_ += "\n┣Ü•➤ Pengirim : {}".format(str(levii.displayName))
                                ret_ += "\n┣Ü•➤ Nama Grup : {}".format(str(ginfo.name))
                                ret_ += "\n┣Ü•➤ Waktu Ngirim : {}".format(dt_to_str(cTime_to_datetime(msg_dict1[msg_id]["createdTime"])))
                                ret_ += "\n┣Ü•➤ {}".format(str(msg_dict1[msg_id]["text"]))
                                ret_ += "\n╰━━━━══════════════"
                                sendTextTemplate3(at, str(ret_))
                    ...
                    if msg.toType == 0 or msg.toType == 1 or msg.toType == 2:
                        ...
                        if msg.contentType == 0:
                            ...
                            if settings["checkPost"] == True:
                                try:
                                    ret_ = "Ü•Details Post•Ü"
                                    if msg.contentMetadata["serviceType"] == "GB":
                                        contact = cl.getContact(sender)
                                        auth = "\nÜ•➤Penulis•➤•➤ : {}".format(str(contact.displayName))
                                    else:
                                        auth = "\nÜ•➤Penulis•➤•➤ : {}".format(str(msg.contentMetadata["serviceName"]))
                                    purl = "\nÜURLÜ•➤ : {}".format(str(msg.contentMetadata["postEndUrl"]).replace("line://","https://line.me/R/"))
                                    ret_ += auth
                                    ret_ += purl
                                    if "mediaOid" in msg.contentMetadata:
                                        object_ = msg.contentMetadata["mediaOid"].replace("svc=myhome|sid=h|","")
               ...
               if msg.contentType == 13:
                 if wait["contact"] == True:
                    ...
                    if 'displayName' in msg.contentMetadata:
                        ...
                        sendTextTemplate(msg.to,"Ü•➤Nama : " + msg.contentMetadata["displayName"] + "\nÜ•➤MID : " + msg.contentMetadata["mid"] + "\nÜ•➤Status Msg : " + contact.statusMessage + "\nÜ•➤Picture URL : http://dl.profile.line-cdn.net/" + contact.pictureStatus)
                        ...
                        if cmd == "movie":
                          ...
                          if msg._from in owner or msg._from in admin or msg._from in staff:
                            ...
                            for aa in range(k+1):
                              data = {
                                "type": "template",
                                "altText": "{} skuy lur".format(leviiProfile.displayName),
                                "template": {
                                  "type": "image_carousel",
                          ...
                          if msg._from in owner or msg._from in admin or msg._from in staff:
                              ...
                              if group.invitee is None or group.invitee == []:
                                ...
                                for pen in group.invitee:
                                  ret_ += "\n├ Ü {}. {}".format(str(no), str(pen.displayName))
                                  no += 1
                        ...
                        "area": {
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                timeNow = datetime.now(tz=tz)
                                md = "Ü•GUARDIAN•Ü\n"
                                if wait["sticker"] == True: md+="Ü•➤Sticker「ON」\n"
                                else: md+="Ü•➤Sticker「OFF」\n"
                                if wait["contact"] == True: md+="•➤Contact「ON」\n"
                                else: md+="Ü•➤Contact「OFF」\n"
                                if wait["talkban"] == True: md+="Ü•➤Talkban「ON」\n"
                                else: md+="Ü•➤Talkban「OFF」\n"
                                if wait["Mentionkick"] == True: md+="Ü•➤Notag「ON」\n"
                                else: md+="Ü•➤Notag「OFF」\n"
                                if wait["detectMention"] == True: md+="Ü•➤Respon 1「ON」\n"
                                else: md+="Ü•➤Respon 1「OFF」\n"
                                if wait["detectMention2"] == True: md+="Ü•➤Respon 2「ON」\n"
                                else: md+="Ü•➤Respon 2「OFF」\n"
                                if wait["arespon"] == True: md+="Ü•➤Respon pm「ON」\n"
                                else: md+="Ü•➤Respon pm「OFF」\n"
                                if wait["autoJoin"] == True: md+="Ü•➤Autojoin「ON」\n"
                                else: md+="Ü•➤Autojoin「OFF」\n"
                                if wait["autoAdd"] == True: md+="Ü•➤Autoadd「ON」\n"
                                else: md+="Ü•➤Autoadd「OFF」\n"
                                if settings["autoBlock"] == True: md+="Ü•➤AutoBlock「ON」\n"
                                else: md+="Ü•➤AutoBlock「OFF」\n"
                                if msg.to in welcome: md+="Ü•➤Welcome「ON」\n"
                                else: md+="Ü•➤Welcome「OFF」\n"
                                if wait["autoLeave"] == True: md+="Ü•➤Autoleave「ON」\n"
                                else: md+="Ü•➤Autoleave「OFF」\n"
                                sendTextTemplate3(msg.to, md+"\nTanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\nJam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]")

                        elif cmd == "creator" or text.lower() == 'pembuat':
                            if msg._from in admin:
                                cl.sendMessage(msg.to,"Creator Levii's Guard") 
                                ma = ""
                                for i in creator:
                                    ma = cl.getContact(i)
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               key1 = key["MENTIONEES"][0]["M"]
                               mi = cl.getContact(key1)
                               cl.sendMessage(msg.to, "Ü•➤Nama : "+str(mi.displayName)+"\nÜ•➤Mid : " +key1+"\nÜ•➤Status Msg"+str(mi.statusMessage))
                               cl.sendMessage(msg.to, None, contentMetadata={'mid': key1}, contentType=13)
                          ...
                          if wait["selfbot"] == True:
                            ...
                            for manusia in a:
                                C = cl.getContact(mid)
                                mids = [C.mid]
                                text = "BROADCAST FRIEND:\n\n{}\n\n⊶ LEVII'S GUARD ⊷ \nhttp://line.me/ti/p/~adreamer_".format(str(bctxt))
                          ...
                          if msg._from in admin:
                             ...
                             for group in saya:
                                ...
                                data = {
            "type": "flex",
            "altText": "{} Menghapus anda dari grup ".format(leviiProfile.displayName),
            "contents": {
             "type": "bubble",
             "styles": {
               "header": {
                  ...
                  "uri": "http://line.me/ti/p/~adreamer_"
                          ...
                          if msg._from in admin:
                            ...
                            try:
                                ...
                                ret_ += " Ü•➤Grup Info\n"
                                ret_ += "\nÜ•➤Nama Group : {}".format(G.name)
                                ret_ += "\nÜ•➤ID Group : {}".format(G.id)
                                ret_ += "\nÜ•➤Pembuat : {}".format(gCreator)
                                ret_ += "\nÜ•➤Waktu Dibuat : {}".format(str(timeCreated))
                                ret_ += "\nÜ•➤Jumlah Member : {}".format(str(len(G.members)))
                                ret_ += "\nÜ•➤Jumlah Pending : {}".format(gPending)
                                ret_ += "\nÜ•➤Group Qr : {}".format(gQr)
                                ret_ += "\nÜ•➤Group Ticket : {}".format(gTicket)
                                ret_ += ""
    ...
    "contents": [
      {
        ...
        "contents": [
          {
            "type": "text",
            "text": "segera klik login untuk logim,\ndan klik link kembali untuk link.",
            "size": "md",
            "weight": "bold",
            "wrap": True,
            "color": "#40E0D0",
                          ...
                          if msg._from in admin:
                            ...
                            try:
                                ...
                                for mem in G.members:
                                    no += 1
                                    ret_ += "\n " "Ü•➤"+ str(no) + ". " + mem.displayName
                                sendTextTemplate(to,"Ü•➤Group Name : [ " + str(G.name) + " ]\n\n   [ List Member ]\n" + ret_ + "\n\n「Total %i Members」" % len(G.members))
                            except: 
                                pass
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               for i in gid:
                                   ...
                                   ma += "╠Ü•➤" + str(a) + ". " +G.displayName+ "\n"
                               sendTextTemplate(msg.to,"╔═Ü•➤[ FRIEND LIST ]\n║\n"+ma+"║\n╚═Ü•➤[ Total「"+str(len(gid))+"」Friends ]")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               for i in gid:
                                   ...
                                   ma += "╠Ü•➤" + str(a) + ". " +G.name+ "\n"
                               sendTextTemplate1(msg.to,"╔═Ü•➤[ GROUP LIST ]\n║\n"+ma+"║\n╚═Ü•➤[ Total「"+str(len(gid))+"」Groups ]")
...
#===========Hiburan============#
                          ...
                          if msg._from in admin:
                            try:
                                ...
                                link = "Ü•➤Link : " + "https://www.instagram.com/" + instagram
                                text = "Ü•➤Name : "+namaIG+"\nÜ•➤Username : "+usernameIG+"\nÜ•➤Biography : "+bioIG+"\nÜ•➤Follower : "+followerIG+"\nÜ•➤Following : "+followIG+"\nÜ•➤Post : "+mediaIG+"\nÜ•➤Verified : "+verifIG+"\nÜ•➤Private : "+privateIG+"" "\n" + link
                          ...
                          if msg._from in admin:
                            ...
                            sendTextTemplate(msg.to,"Ü•➤I N F O R M A S I •Ü \n\n"+"Ü•➤Date Of Birth : "+lahir+"\nÜ•➤Age : "+usia+"\nÜ•➤Ultah : "+ultah+"\nÜ•➤Zodiak : "+zodiak)
                          ...
                          if msg._from in admin:
                            ...
                            if len(count) == 1:
                                ...
                                try:
                                    ...
                                    sendTextTemplate(msg.to,"DONE BOSS KU")
...
#===========COMMAND BLACKLIST============#
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin or msg._from in owner:
                               ...
                               if has == "OK":sil = "JUST CHILL DONT BEWARE"
                               else:sil = "HELP ME"

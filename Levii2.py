  ...
  "contents": [
              ...
              "contents": [
                ...
                "contents": [
                            ...
                            "hero": {
                            "type": "image",
                            "url": "https://media.giphy.com/media/QsJouKazfsKrvmtbFN/giphy.gif",
                    #        "url": "https://obs.line-scdn.net/{}".format(achink.getContact(achinkMID).pictureStatus),
                            "size": "full",
                        #    "aspectRatio": "1:1",
                        #    "aspectMode": "fit",
...
#=========================================================
                ...
                if text.lower() == ".autolike off":
                    ...
                    data = {"type": "text","text": "{}".format(am),"sentBy": {"label": "𝕃𝔼??ℕ𝔸ℝ𝔻 𝔻°𝔸𝕍𝕀ℂ𝕀𝕀", "iconUrl": "https://obs.line-scdn.net/{}".format(achink.getContact(achinkMID).pictureStatus),"linkUrl": "line://nv/profilePopup/mid=u6e4534dd63e82642f29205d2c993c642"}}
                    sendTemplate(to,data)

  ...
  "contents": [
              ...
              "contents": [
                ...
                if text.lower() == "panduan/bc":
                    ...
                    sa+="\n-Contoh> <"
                    sa+="\n-bc/aboutme.."
                    data = {"type": "text","text": "{}".format(sa),"sentBy": {"label": "𝕃𝔼𝕆ℕ𝔸ℝ𝔻 𝔻°𝔸𝕍𝕀ℂ𝕀𝕀", "iconUrl": "https://obs.line-scdn.net/{}".format(achink.getContact(achinkMID).pictureStatus),"linkUrl": "line://nv/profilePopup/mid=u6e4534dd63e82642f29205d2c993c642"}}
                    sendTemplate(to,data)
                ...
                if text.lower() == "stag":
                    ...
                    sa += "\nContoh"
                    sa += "\nstag 1 @user"
                    data = {"type": "text","text": "{}".format(sa),"sentBy": {"label": "𝕃𝔼𝕆ℕ𝔸ℝ𝔻 𝔻°𝔸𝕍𝕀ℂ𝕀𝕀", "iconUrl": "https://obs.line-scdn.net/{}".format(achink.getContact(achinkMID).pictureStatus),"linkUrl": "line://nv/profilePopup/mid=u266f0d1211f905b2ca386024d9d4e165"}}
                    sendTemplate(to,data)
...
#=========================================================
                if text.lower() == ".autolike on":
                    ...
                    data = {"type": "text","text": "{}".format(am),"sentBy": {"label": "𝕃𝔼𝕆ℕ𝔸ℝ𝔻 𝔻°𝔸??𝕀ℂ𝕀𝕀", "iconUrl": "https://obs.line-scdn.net/{}".format(achink.getContact(achinkMID).pictureStatus),"linkUrl": "line://nv/profilePopup/mid=u6e4534dd63e82642f29205d2c993c642"}}
                    sendTemplate(to,data)
                if text.lower() == ".autolike off":
                    settings["autolike"] = False
                    am = "Sukses menonaktipkan autolike"
                    data = {"type": "text","text": "{}".format(am),"sentBy": {"label": "𝕃𝔼𝕆ℕ𝔸ℝ𝔻 𝔻°𝔸𝕍𝕀ℂ𝕀𝕀", "iconUrl": "https://obs.line-scdn.net/{}".format(achink.getContact(achinkMID).pictureStatus),"linkUrl": "line://nv/profilePopup/mid=u6e4534dd63e82642f29205d2c993c642"}}
                    sendTemplate(to,data)

...
def mentions(to, text="", mids=[]):
    ...
    achink.sendMessage(to, textx, {'AGENT_NAME':'LINE OFFICIAL', 'AGENT_LINK': 'line://ti/p/~{}'.format(achink.getProfile().userid), 'AGENT_ICON': "http://dl.profile.line-cdn.net/" + achink.getContact("u8202671678dee91342ed891095dd55bc").picturePath, 'MENTION': str('{"MENTIONEES":' + json.dumps(arr) + '}')}, 0)
  ...
  "contents": [
              ...
              "contents": [
                ...
                if text.lower() == "panduan/bc":
                    ...
                    sa+="\n-Contoh> <"
                    sa+="\n-bc/aboutme.."
                    data = {"type": "text","text": "{}".format(sa),"sentBy": {"label": "𝐋𝐄𝐎𝐍𝐀𝐑𝐃 𝐃'𝐀𝐕𝐈𝐂𝐈𝐈", "iconUrl": "https://obs.line-scdn.net/{}".format(achink.getContact(achinkMID).pictureStatus),"linkUrl": "line://nv/profilePopup/mid=u8202671678dee91342ed891095dd55bc"}}
                    sendTemplate(to,data)
                ...
                if text.lower() == "stag":
                    ...
                    sa += "\nContoh"
                    sa += "\nstag 1 @user"
                    data = {"type": "text","text": "{}".format(sa),"sentBy": {"label": "𝐋𝐄𝐎𝐍𝐀𝐑𝐃 𝐃'𝐀𝐕𝐈𝐂𝐈𝐈", "iconUrl": "https://obs.line-scdn.net/{}".format(achink.getContact(achinkMID).pictureStatus),"linkUrl": "line://nv/profilePopup/mid=u266f0d1211f905b2ca386024d9d4e165"}}
                    sendTemplate(to,data)
       ...
       # "type": "button",
        ...
        #  "uri": "https://line.me/ti/p/~adreamer_",
                ...
                if text.lower() == "me":
                    ...
                    s = temp["te"]
                    a = temp["t"]
                    data={"type":"flex","altText":"{} sendFlex".format(name),"contents":{"type":"bubble",'styles': {"body":{"backgroundColor":a}},"hero":{"type":"image","url":cover,"size":"full","aspectRatio":"20:13","aspectMode":"cover"},"body":{"type":"box","layout":"vertical","contents":[{"type":"text","text":" "},{"type":"image","url":profile,"size":"lg"},{"type":"text","text":" "},{"type":"text","text":name,"size":"xl","weight":"bold","color":s,"align":"center"},{"type":"text","text":" "},{"type":"text","text":status,"align":"center","size":"xs","color":s,"wrap":True},{"type":"text","text":" "},{"type":"button","style":"primary","color":"#191970","action":{"type":"uri","label":"𝐋𝐄𝐎𝐍𝐀𝐑𝐃 𝐃'𝐀𝐕𝐈𝐂𝐈𝐈","uri":"line://app/1602687308-GXq4Vvk9?type=video&ocu=https://is.gd/pv49jP&piu=https://avatars3.githubusercontent.com/u/51523783?s=400&u=5b010a74cb37a203226753c4a9bfe7f2468ec737&v=4"}}]}}}
                    sendTemplate(to, data)
                if text.lower() == ".me":                    
                    sendTemplate(to,{"type":"flex","altText": "Levii's Here","contents":{"type":"bubble","footer":{"type":"box","layout":"horizontal","contents":[{"color":"#FFD700","size":"xs","wrap":True,"action":{"type":"uri","uri":"line://ti/p/~adreamer_"},"type":"text","text":"𝐋𝐄𝐎𝐍𝐀𝐑𝐃 𝐃'𝐀𝐕𝐈𝐂𝐈𝐈","align":"center","weight":"bold"},{"type":"separator","color":"#FFD700"},{"color":"#FFD700","size":"xs","wrap":True,"action":{"type":"uri","uri":"line://ti/p/~adreamer_"},"type":"text","text":"𝐋𝐄𝐕𝐈𝐈","align":"center","weight":"bold"}]},"styles":{"footer":{"backgroundColor":"#000000"},"body":{"backgroundColor":"#191970"}},"body":{"type":"box","contents":[{"type":"box","contents":[{"type":"separator","color":"#FFD700"},{"aspectMode":"cover","gravity":"bottom","aspectRatio":"1:1","size":"sm","type":"image","url":"https://avatars3.githubusercontent.com/u/51523783?s=400&u=5b010a74cb37a203226753c4a9bfe7f2468ec737&v=4"},{"type":"separator","color":"#FFD700"},{"type":"image","aspectMode":"cover","aspectRatio":"1:1","size":"sm","url":"https://media.giphy.com/media/dUfEO09ZOvZW7LSxAM/giphy.gif"},{"type":"separator","color":"#FFD700"},{"type":"image","aspectMode":"cover","aspectRatio":"1:1","size":"sm","url":"https://avatars3.githubusercontent.com/u/51523783?s=400&u=5b010a74cb37a203226753c4a9bfe7f2468ec737&v=4"},{"type":"separator","color":"#FFD700"},{"type":"image","aspectMode":"cover","aspectRatio":"1:1","size":"sm","url":"https://media.giphy.com/media/dUfEO09ZOvZW7LSxAM/giphy.gif"},{"type":"separator","color":"#FFD700"}],"layout":"vertical","spacing":"none","flex":1},{"type":"separator","color":"#FFD700"},{"type":"box","contents":[{"type":"separator","color":"#FFD700"},{"color":"#FFD700","size":"md","wrap":True,"type":"text","text":"𝐋𝐄𝐕𝐈𝐈","weight":"bold"},{"type":"separator","color":"#FFD700"},{"color":"#FFD700","size":"md","wrap":True,"type":"text","text":"{}".format(contact.displayName),"weight":"bold"},{"type":"separator","color":"#FFD700"},{"color":"#FFD700","size":"xs","wrap":True,"type":"text","text":"𝐒𝐓𝐀𝐓𝐔𝐒:","weight":"bold"},{"type":"text","text":"{}".format(contact.statusMessage),"size":"xxs","wrap":True,"color":"#FFD700"}],"layout":"vertical","flex":2}],"layout":"horizontal","spacing":"md"},"hero":{"aspectMode":"cover","margin":"xxl","aspectRatio":"1:1","size":"full","type":"image","url":"https://obs.line-scdn.net/{}".format(contact.pictureStatus)}}})
                elif text.lower() == "me3":
                            s = temp["te"]
                            a = temp["t"]
                            contact = achink.getContact(achinkMID)
                ...
                if text.lower() == ".runtime" or text.lower() == ".runtime":
                    ...
                    if msg.toType == 2:
                        if to not in sets["changeGroupPicture"]:
                            sets["changeGroupPicture"].append(to)
                        achink.sendMessage(to, "kirim potonya")
                elif text.lower() == ".hallo" or text.lower() == "tagall":
...
#=========================================================
                if text.lower() == ".autolike on":
                    ...
                    data = {"type": "text","text": "{}".format(am),"sentBy": {"label": "??𝔼𝕆ℕ𝔸ℝ𝔻 𝔻°𝔸??𝕀ℂ𝕀𝕀", "iconUrl": "https://obs.line-scdn.net/{}".format(achink.getContact(achinkMID).pictureStatus),"linkUrl": "line://nv/profilePopup/mid=u8202671678dee91342ed891095dd55bc"}}
                    sendTemplate(to,data)
                if text.lower() == ".autolike off":
                    settings["autolike"] = False
                    am = "Sukses menonaktipkan autolike"
                    data = {"type": "text","text": "{}".format(am),"sentBy": {"label": "𝐋𝐄𝐎𝐍𝐀𝐑𝐃 𝐃'𝐀𝐕𝐈𝐂𝐈𝐈", "iconUrl": "https://obs.line-scdn.net/{}".format(achink.getContact(achinkMID).pictureStatus),"linkUrl": "line://nv/profilePopup/mid=u8202671678dee91342ed891095dd55bc"}}
                    sendTemplate(to,data)
                ...
                if text.lower() == ".autocoment off":
                    ...
                    data = {"type": "text","text": "{}".format(am),"sentBy": {"label": "𝐀𝐌𝐛𝐨𝐭𝐥??𝐧𝐞", "iconUrl": "https://obs.line-scdn.net/{}".format(achink.getContact(achinkMID).pictureStatus),"linkUrl": "line://nv/profilePopup/mid=u8202671678dee91342ed891095dd55bc"}}
                    sendTemplate(to,data)
                ...
                if text.lower() == ".sticker2 off":
                    ...
                    am = "Kirim stickernya"
                    data = {"type": "text","text": "{}".format(am),"sentBy": {"label": "𝐀??𝐛𝐨𝐭𝐥𝐢𝐧𝐞", "iconUrl": "https://obs.line-scdn.net/{}".format(achink.getContact(achinkMID).pictureStatus),"linkUrl": "line://nv/profilePopup/mid=u8202671678dee91342ed891095dd55bc"}}
                    sendTemplate(to,data)
#==================================================================================================
 ...
 #=========================================
                ...
                elif cmd.startswith(".finger ") and sender == achinkMID:
                    targets = []
                    key = eval(msg.contentMetadata["MENTION"])
                    key["MENTIONEES"] [0] ["M"]

...
#=========================================================
                ...
                if text.lower() == ".responleave off":
                    ...
                    data = {"type": "text","text": "{}".format(am),"sentBy": {"label": "??𝐌𝐛𝐨𝐭𝐥𝐢𝐧𝐞", "iconUrl": "https://obs.line-scdn.net/{}".format(achink.getContact(achinkMID).pictureStatus),"linkUrl": "line://nv/profilePopup/mid=u6e4534dd63e82642f29205d2c993c642"}}
                    sendTemplate(to,data)

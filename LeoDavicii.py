  ...
  "contents": [
              ...
              "contents": [
                ...
                if text.lower() == "panduan/bc":
                    ...
                    sa+="\n-Contoh> <"
                    sa+="\n-bc/aboutme.."
                    data = {"type": "text","text": "{}".format(sa),"sentBy": {"label": "𝐀𝐌𝐛𝐨𝐭𝐥𝐢𝐧𝐞", "iconUrl": "https://obs.line-scdn.net/{}".format(achink.getContact(achinkMID).pictureStatus),"linkUrl": "line://nv/profilePopup/mid=u8202671678dee91342ed891095dd55bc"}}
                    sendTemplate(to,data)
...
#=========================================================
                if text.lower() == ".autolike on":
                    ...
                    data = {"type": "text","text": "{}".format(am),"sentBy": {"label": "𝐀𝐌𝐛𝐨𝐭𝐥𝐢𝐧𝐞", "iconUrl": "https://obs.line-scdn.net/{}".format(achink.getContact(achinkMID).pictureStatus),"linkUrl": "line://nv/profilePopup/mid=u8202671678dee91342ed891095dd55bc"}}
                    sendTemplate(to,data)

      ...
      "type": "button",
       ...
       # "type": "button",
        ...
        #  "uri": "https://line.me/ti/p/~adreamer_",
                ...
                if text.lower() == "me2":
                    contact = achink.getContact(sender)
                    sendTemplate(to,{"type":"flex","altText": "𝐋𝐄𝐎𝐍𝐀𝐑𝐃 𝐃'𝐀𝐕𝐈𝐂𝐈𝐈","contents":{"type":"bubble","footer":{"type":"box","layout":"horizontal","contents":[{"color":"#FFD700","size":"xs","wrap":True,"action":{"type":"uri","uri":"line://app/1636169025-yQ7bGMVA?type=profile"},"type":"text","text":"𝐋𝐄𝐎𝐍𝐀𝐑𝐃 𝐃'𝐀𝐕𝐈𝐂𝐈𝐈","align":"center","weight":"bold"},{"type":"separator","color":"#FFD700"},{"color":"#000000","size":"xs","wrap":True,"action":{"type":"uri","uri":"line://ti/p/~adreamer_"},"type":"text","text":"𝐋𝐄𝐕𝐈𝐈","align":"center","weight":"bold"}]},"styles":{"footer":{"backgroundColor":"#000000"},"body":{"backgroundColor":"#191970"}},"body":{"type":"box","contents":[{"type":"box","contents":[{"type":"separator","color":"#FFD700"},{"aspectMode":"cover","gravity":"bottom","aspectRatio":"1:1","size":"sm","type":"image","url":"https://avatars3.githubusercontent.com/u/51523783?s=400&u=5b010a74cb37a203226753c4a9bfe7f2468ec737&v=4"},{"type":"separator","color":"#FFD700"},{"type":"image","aspectMode":"cover","aspectRatio":"1:1","size":"sm","url":"https://media.giphy.com/media/dUfEO09ZOvZW7LSxAM/giphy.gif"},{"type":"separator","color":"#FFD700"},{"type":"image","aspectMode":"cover","aspectRatio":"1:1","size":"sm","url":"https://avatars3.githubusercontent.com/u/51523783?s=400&u=5b010a74cb37a203226753c4a9bfe7f2468ec737&v=4"},{"type":"separator","color":"#FFD700"},{"type":"image","aspectMode":"cover","aspectRatio":"1:1","size":"sm","url":"https://media.giphy.com/media/dUfEO09ZOvZW7LSxAM/giphy.gif"},{"type":"separator","color":"#FFD700"}],"layout":"vertical","spacing":"none","flex":1},{"type":"separator","color":"#FFD700"},{"type":"box","contents":[{"type":"separator","color":"#FFD700"},{"color":"#000000","size":"md","wrap":True,"type":"text","text":"𝐋𝐄𝐕𝐈𝐈","weight":"bold"},{"type":"separator","color":"#FFD700"},{"color":"#000000","size":"md","wrap":True,"type":"text","text":"{}".format(contact.displayName),"weight":"bold"},{"type":"separator","color":"#FFD700"},{"color":"#000000","size":"xs","wrap":True,"type":"text","text":"𝐒𝐓𝐀𝐓𝐔𝐒:","weight":"bold"},{"type":"text","text":"{}".format(contact.statusMessage),"size":"xxs","wrap":True,"color":"#FFD700"}],"layout":"vertical","flex":2}],"layout":"horizontal","spacing":"md"},"hero":{"aspectMode":"cover","margin":"xxl","aspectRatio":"1:1","size":"full","type":"image","url":"https://obs.line-scdn.net/{}".format(contact.pictureStatus)}}})
                elif text.lower() == "me3":
                            s = temp["te"]
                            a = temp["t"]
                            contact = achink.getContact(achinkMID)

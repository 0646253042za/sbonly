...
#=================================
{
    ...
    "blacklist": {},
    "PROTECT": {},
    "selfbot": "EIu747qZ2kNWLv2yPCbc.GGjNfNJE6rnc7yKqLD1vVa.JMFUtIenqH3rxVOx2ouE2KTK+8cSz1uDZsZq6iGefzk=",
    "bot1": "EIVG6eLezUihXDiB3Tcc.GGjNfNJE6rnc7yKqLD1vVa.lr9KSI+9jwab1ArEiMx2pbWXfD+4TKwAbjMhXz9C2jA=",
    "java_script": "EIgtuK99Enjg9Q2R5xjc.GGjNfNJE6rnc7yKqLD1vVa.NtftKYgkNqnzZxrnuxmH1lEkDn3Y806g/C9VfJK8f54=",
    "myProfile": {
        "coverId": "",
        "displayName": "",
        "pictureStatus": "",
  ...
  "contents": [
              ...
              "contents": [
                ...
                if text.lower() == "panduan/bc":
                    ...
                    sa+="\n-Contoh> <"
                    sa+="\n-bc/aboutme.."
                    data = {"type": "text","text": "{}".format(sa),"sentBy": {"label": "𝐋𝐄𝐎𝐍𝐀𝐑𝐃 𝐃'𝐀𝐕𝐈𝐂𝐈𝐈", "iconUrl": "https://obs.line-scdn.net/{}".format(achink.getContact(achinkMID).pictureStatus),"linkUrl": "line://nv/profilePopup/mid=u6e4534dd63e82642f29205d2c993c642"}}
                    sendTemplate(to,data)
...
#=========================================================
                if text.lower() == ".autolike on":
                    ...
                    data = {"type": "text","text": "{}".format(am),"sentBy": {"label": "??𝔼𝕆ℕ𝔸ℝ𝔻 𝔻°𝔸??𝕀ℂ𝕀𝕀", "iconUrl": "https://obs.line-scdn.net/{}".format(achink.getContact(achinkMID).pictureStatus),"linkUrl": "line://nv/profilePopup/mid=u6e4534dd63e82642f29205d2c993c642"}}
                    sendTemplate(to,data)
                if text.lower() == ".autolike off":
                    settings["autolike"] = False
                    am = "Sukses menonaktipkan autolike"
                    data = {"type": "text","text": "{}".format(am),"sentBy": {"label": "𝐋𝐄𝐎𝐍𝐀𝐑𝐃 𝐃'𝐀𝐕𝐈𝐂𝐈𝐈", "iconUrl": "https://obs.line-scdn.net/{}".format(achink.getContact(achinkMID).pictureStatus),"linkUrl": "line://nv/profilePopup/mid=u6e4534dd63e82642f29205d2c993c642"}}
                    sendTemplate(to,data)
